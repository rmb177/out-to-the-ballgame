...
(function() {
  var dateChanged, displayGamesForDate, formatDate, gGameMarkers, gMap, getInitialMapDate, initMap;
  ...
  getInitialMapDate = function() {
    var mapDate, openingDay, today;
    openingDay = new Date("4/5/2015");
    today = new Date;
    mapDate = today > openingDay ? today : openingDay;
    return mapDate;
  };
